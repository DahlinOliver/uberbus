...
function PaymentMethod2() {
    return (
        ...
        <div className="container">
            ...
            <Row>
                <Column><Link to="/samsungpay2"><Center><Img src={Samsung} alt="samsung-logo"></Img></Center></Link></Column>
                <Column><Link to="/googlepay2"><Center><Img src={Google} alt="google-logo"></Img></Center></Link></Column>
                <Column><Link to="/applepay2"><Center><Img src={Apple} alt="apple-logo"></Img></Center></Link></Column>
                <Column><Link to="/paypal2"><Center><Img src={PayPal} alt="paypal-logo"></Img></Center></Link></Column>
            </Row>
